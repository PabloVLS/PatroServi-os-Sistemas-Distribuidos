...
async function carregarProfissionais() {
  ...
  let url = (window.API_BASE || '') + '/api/profissionais';
  const params = [];
  ...
  try {
    ...
    listaDiv.innerHTML = dados.map(d => {
      ...
      const fotoPerfil = d.perfil?.fotoPerfil || null;
      return `
          ...
          <div class="card h-100 shadow-sm border-0"> 
            <div class="card-body d-flex flex-column p-3">
              <div class="d-flex align-items-center mb-3">
                ${fotoPerfil ? 
                  `<img src="${fotoPerfil}" alt="${d.nome}" class="rounded-circle me-3" style="width:56px;height:56px;object-fit:cover;">` :
              ...
              <div class="d-flex justify-content-between align-items-center mt-auto">
                ...
                <a class="btn btn-sm btn-primary" href="perfil-profissional.html?id=${d.id}">
                  <i class="bi bi-eye"></i>
                </a>
              </div>
            </div>
